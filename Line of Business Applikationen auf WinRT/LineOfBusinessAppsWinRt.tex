...
\subsection[Dependency Properties]{Dependency Properties}
...
\newline
\newline
In Listing \ref{lst:styles_templates} ist dargestellt, wie ein Style für TextBlock-Elemente innerhalb der definierten ListView definiert wird, der die \textit{FontWeight} auf \textit{Bold}, die \textit{Foreground}-Farbe auf \textit{Red}, und ein \textit{Padding} von links auf 20 setzt.
\newline
...
\newline
\begin{lstlisting}[caption={Styles und Templates}\label{lst:styles_templates},captionpos=t]
