...
Für die Anwendung Practitioner Mobile wurde ein eigenes Control entwickelt, das es erlaubt, für einen bestimmten Patienten einen Ordinationseintrag hinzuzufügen. Das Control ist in Abbildung \ref{img:customcontrol} ersichtlich. Der vollständige Code dazu befindet sich im Anhang unter \ref{app:generic} und \ref{app:ordinationmask}.
\newline
\newline
...
Wenn die Daten nicht geteilt, sondern in etwa an einen Drucker gesendet werden können, kommt der Charm-Eintrag \textit{Geräte} ins Spiel. Auch die Verwendung dieser Funktionalität ist sehr trivial.
\newline
...
% Anh"ange
\begin{appendix}
\chapter[Generic.xaml]{Generic.xaml}\label{app:generic}
...
\chapter[OrdinationMask.cs]{OrdinationMask.cs}\label{app:ordinationmask}
