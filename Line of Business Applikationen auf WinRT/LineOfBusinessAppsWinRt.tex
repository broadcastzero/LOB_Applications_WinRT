...
Für die Anwendung Practitioner Mobile wurde ein eigenes Control entwickelt, das es erlaubt, für einen bestimmten Patienten einen Ordinationseintrag hinzuzufügen. Das Control ist in Abbildung \ref{img:customcontrol} ersichtlich. Der vollständige Code dazu befindet sich im Anhang.
\newline
\newline
...
% Anh"ange
\begin{appendix}
\chapter[Generic.xaml]{Generic.xaml}
...
\chapter[OrdinationMask.cs]{OrdinationMask.cs}
